...
public class OwnerVehiclesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT vehicle_id, vehicle_name, COALESCE(vehicle_model,'') AS vehicle_model, vehicle_type, vehicle_number, rent_per_day, availability, COALESCE(status,'Available') AS status, image_url FROM vehicle WHERE owner_id = ? ORDER BY created_at DESC";
