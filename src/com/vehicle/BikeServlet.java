		...
		try {
			...
			if(con != null) {
				System.out.print("Connection Successfull");
				                ...
				                // New schema: select bikes that are available and approved
                String sql = "SELECT vehicle_id, owner_id, vehicle_name, vehicle_type, image_url, rent_per_day, availability FROM vehicle WHERE vehicle_type = ? AND availability = true AND approval_status = 'approved'";
