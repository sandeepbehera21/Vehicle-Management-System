          ...
          <form action="<%= request.getContextPath() %><%= isEdit ? "/owner/vehicles/edit" : "/owner/vehicles/new" %>" method="POST" <%= isEdit ? "" : "enctype=\"multipart/form-data\"" %>>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="number" step="0.01" min="0" name="rent_per_day" class="form-control" placeholder="Enter rent in Rupees" value="<%= request.getAttribute("rent_per_day") != null ? request.getAttribute("rent_per_day") : "" %>" required>
              </div>
              <% if (isEdit) { %>
              <div class="col-md-6">
